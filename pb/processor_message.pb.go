...
func (x *CPUMessage) GetBrand() string {
	if x != nil {
		return x.Brand
	}
	return ""
...
func (x *CPUMessage) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CPUMessage) GetNumberThreads() uint32 {
	if x != nil {
...
func (x *CPUMessage) GetNumberCores() uint32 {
	if x != nil {
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x22, 0x80, 0x01, 0x0a, 0x0a, 0x43, 0x50, 0x55, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x43, 0x6f,
	0x72, 0x65, 0x73, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPUMessage)(nil), // 0: proto.CPUMessage
}
